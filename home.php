...
$birth = $month. " ".$date.", ".$year;
  ...
  if( in_array($imageFileType,$extensions_arr) ){       
      ...
      $sql = "Insert into members(name,address,age,birth,alias,chapter,gt,mi,image,years,welcome)VALUES('$n','$address','$age','$birth','$alias','$chapter','$gt','$mi','$name','$year','$welcome')";
    ...
    <head>
        ...
        <script>
            function validate(){
             ...
             if(welcome == "" || welcome == null || file == "" || file == null || n == "" || n == null || add == "" || add == null || age == "" || age == null || alias == "" || alias == null || chapter=="" || chapter == "" || gt == "" || gt == null || mi == "" || mi == null){
                 alert("Please input all required fields. .");
                 return false;
             }else{
                 alert("Successfully add member. Thank you");
                 return true;
             }
  ...
  if (r == true) {
    ...
    <body style="background-color:black">
        <div style="float:">
            ...
            <br>
            <a href="home.php"><button style="height: 30px;width:260px;background-color: white">ADD MEMBERS</button></a><br/>
        ...
        <div style="margin: 0 auto;height: 500px;width:800px;border:1px solid black;border-radius: 5px;margin-top: -420px">
            ...
            <form method="POST" action="" enctype='multipart/form-data' onsubmit="return validate()">
                <table style="margin-left:80px">
                     <tr>
                        <td>Name:</td>
                        <td><input type="text" placeholder="Name" name="n" id="n"/></td>
                    </tr>
                    <tr>
                        <td>Address:</td>
                    ...
                    <tr>
                        <td>Age:</td>
                        <td><input placeholder="Age" type="number"  name="age" id="age"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Alias:</td>
                        <td><input type="text" placeholder="Alias" name="alias" id="alias"/></td>
                    </tr>
                    <tr>
                        <td>Alma Mater Chapter:</td>
                        <td><input type="text" placeholder="Alma Mater Chapter" name="chapter" id="chapter"/></td>
                    </tr>
                   
                    <tr>
                        <td>GT:</td>
                        <td><input type="gt" placeholder="GT" name="gt" id="gt"/></td>
                    </tr>
                    <tr>
                        <td>MI:</td>
                        <td><input placeholder="MI" type="text"  name="mi" id="mi"/></td>
                    </tr>
                     <tr>
                        <td>Welcome Chapter (optional):</td>
                        <td><input type="text" placeholder="Chapter" name="welcome" id="welcome"/></td>
                    </tr>
                    <tr>
